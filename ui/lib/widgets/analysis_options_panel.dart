...
class AnalysisOptionsSubtitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final analysisOptions = context.select<GeneModel, AnalysisOptions>((model) => model.analysisOptions?? AnalysisOptions());
    return Text(
...
class _AnalysisOptionsPanelState extends State<AnalysisOptionsPanel> {
  ...
  Widget build(BuildContext context) {
    final markers =
    context.select<GeneModel, List<String>>((model) => model.markers);
    return Align(
