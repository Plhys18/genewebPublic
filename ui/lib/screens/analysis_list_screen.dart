...
class _AnalysisListScreenState extends State<AnalysisListScreen> {
  ...
  void _loadAnalysisSettings(AnalysisHistoryEntry analysis) async {
    setState(() {
      _loading = true;
    });
    ...
    try {
      final geneModel = GeneModel.of(context);
      await geneModel.fetchOrganismDetails(analysis.organismName);
  ...
  void _navigateToDetails(AnalysisHistoryEntry analysis) {
    _loadAnalysisSettings(analysis);
    Navigator.push(
      context,
      MaterialPageRoute(
                    ...
                    trailing: Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () => _navigateToDetails(analysis),
                        ),
                      ],
                    ),
                  ),
