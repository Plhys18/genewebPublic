...
class Motif:
    ...
    @property
    def reg_exp(self) -> Dict[str, re2._Regexp]:
        """
    ...
    @property
    def reverse_complement_reg_exp(self) -> Dict[str, re2._Regexp]:
        """
    ...
    @staticmethod
    def to_reg_exp(definition: str, strict: bool = False) -> re2._Regexp:
        """
